...
var EmployeeController = /** @class */ (function () {
    ...
    EmployeeController.prototype.createEmployee = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.employeeService.createEmployee(req.body)];
                    case 1:
                        employee = _a.sent();
    ...
    EmployeeController.prototype.getAllEmployees = function (_req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var employees;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.employeeService.getAllEmployees()];
                    case 1:
                        employees = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, this.employeeService.getEmployeeById(parseInt(id))];
                    case 1:
                        employee = _a.sent();
                        if (employee) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, this.employeeService.updateEmployee(parseInt(id), req.body)];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, this.employeeService.deleteEmployee(parseInt(id))];
                    case 1:
                        _a.sent();
