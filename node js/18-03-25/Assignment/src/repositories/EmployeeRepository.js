...
var EmployeeRepository = /** @class */ (function () {
    ...
    EmployeeRepository.prototype.create = function (employee) {
        return __awaiter(this, void 0, void 0, function () {
            var newEmployee;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newEmployee = this.repository.create(employee);
                        return [4 /*yield*/, this.repository.save(newEmployee)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    EmployeeRepository.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EmployeeRepository.prototype.update = function (id, employee) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.update(id, employee)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    EmployeeRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
