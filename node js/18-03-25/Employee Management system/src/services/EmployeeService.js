...
var EmployeeService = /** @class */ (function () {
    ...
    EmployeeService.prototype.createEmployee = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.employeeRepository.create(data)];
    ...
    EmployeeService.prototype.getAllEmployees = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.employeeRepository.findAll()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EmployeeService.prototype.getEmployeeById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.employeeRepository.findById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EmployeeService.prototype.updateEmployee = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.employeeRepository.update(id, data)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
